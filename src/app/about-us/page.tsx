        ...
        <div className="w-full ">
            ...
            <aside>
              ...
              <div className="mt-5">
                ...
                <ul className="text-gray-800 mt-4 space-y-2">
                  <li>
                    🌍 <strong>Inspiring Exploration</strong>: Encourage
                    travelers to discover new destinations through shared
                    stories.
                  </li>
                  <li>
          ...
          <div className="w-full">
            ...
            <p className="text-gray-600  text-center md:w-1/2 mx-auto">
              ...
              bringing you the best travel experiences, tips, and inspiration
              from around the globe. 🌍✈️ Together, we work to build a community
              that connects and empowers adventurers everywhere.
            </p>
